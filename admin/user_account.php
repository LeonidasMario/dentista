...
?>
     ...
     <html lang="pt-br">
       ...
       <section class="accounts">
        <div class="heading">
          <h1><img src="../images/separator.png" > Usuários registrados<img src="../images/separator.png"></h1>
        </div>
           <div class="box-container">
            ...
            if($select_users->rowCount() > 0){
                while($fetch_users = $select_users->fetch(PDO::FETCH_ASSOC)){
                    ...
                    ?>
                    <div class="box">
                        <h3 class="name"><?= $fetch_users['name'];?></h3>
                        <img src ="../images/<?= htmlspecialchars($fetch_users['image']); ?>" alt="user image">
